      ...
      <div className="w-full max-w-3xl px-6 text-center space-y-10">
        ...
        <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
          ...
          <div className='flex items-center gap-2'>
            ...
            <input type="text" placeholder="Quando" className="bg-transparent w-40 outline-0" />
          </div>

          <div className='w-px h-6 bg-zinc-800'></div>

          <button className='bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-lime-400 transition-colors'>Continuar <ArrowRight className='size-5' /></button>
        </div>
