                ...
                <Dialog.Portal>
                  ...
                  <Dialog.Content className="data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[640px] translate-x-[-50%] translate-y-[-50%] rounded-xl bg-zinc-900 py-5 px-6 shadow-shape focus:outline-none space-y-5">
                    ...
                    <main className="flex flex-wrap gap-2">
                      {emailsToInvite.length === 0 && (
                        <p className="text-sm text-zinc-400 block">Nenhum email cadastrado!</p>
                      )}
                  ...
                  <Dialog.Content className="data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[640px] translate-x-[-50%] translate-y-[-50%] rounded-xl bg-zinc-900 py-5 px-6 shadow-shape focus:outline-none space-y-5">
                    <header className="space-y-2">
                      ...
                      <Dialog.Description className="text-sm text-zinc-400">
                        ...
                        <strong className="text-zinc-100 font-semibold">16 a 27 de Agosto de 2024</strong> preencha seus
                        dados abaixo:
                      </Dialog.Description>
                    </header>

                    <main>
                      <form onSubmit={addNewEmailToInvite} className="flex flex-col gap-2">
